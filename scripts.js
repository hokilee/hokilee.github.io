...
const translations = {
  ko: {
    ...
    'notice.updateContent20251222': `<strong>2025-12-22</strong> - eBook Series 게시판과 한줄 지식/잡학 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.27 — BSC의 4대 관점 — 조직의 균형을 설계하는 방법」가 업데이트되었습니다. BSC(Balanced Scorecard)의 네 가지 관점인 재무, 고객, 내부 프로세스, 학습과 성장을 각각 어떻게 설계하고 연결하는지에 대한 내용을 담고 있습니다. 각 관점의 핵심 지표를 설정하고, 관점 간의 인과관계를 파악하여 조직의 전략을 실행하는 방법을 다룹니다. 단순히 지표를 나열하는 것이 아니라, 조직의 비전과 전략을 네 가지 관점으로 구체화하고, 각 관점이 서로 어떻게 연결되어 있는지 이해하는 것이 중요합니다. <strong>영업, 자기관리, 마케팅, 성과 분석</strong> 등 실무 인사이트를 담은 eBook 시리즈 스물일곱 번째 자료입니다.<br /><br />
💡 <strong>한줄 지식/잡학:</strong> 「주의의 선택적 집중, 왜 중요한 것을 놓치는가」에서는 우리가 동시에 여러 정보를 처리할 수 없기 때문에 주의를 집중할 대상을 선택해야 하는 현상을 설명합니다. 이 과정에서 중요한 정보를 놓치거나 예상치 못한 사건을 인지하지 못하는 현상이 발생합니다. 이러한 현상을 주의의 선택적 집중 또는 주의 맹점이라고 합니다. 우리 뇌는 제한된 인지 자원을 효율적으로 사용하기 위해 주의를 선택적으로 집중하지만, 이로 인해 놓치는 정보가 생깁니다. 고릴라 실험, 운전 중 휴대폰 사용, 멀티태스킹 등 다양한 상황에서 나타나는 주의의 선택적 집중의 개념, 발생 원인, 실생활 예시, 그리고 대응 방법을 상세히 다룹니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251222': `<strong>2025-12-22</strong> – We've added new content to the eBook Series board and One-line Knowledge/Trivia board.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.27 — BSC's Four Perspectives — How to Design Organizational Balance" has been updated. This volume covers how to design and connect the four perspectives of BSC (Balanced Scorecard): financial, customer, internal processes, and learning and growth. It explores how to set key indicators for each perspective, understand the causal relationships between perspectives, and execute organizational strategy. Rather than simply listing indicators, it emphasizes the importance of concretizing the organization's vision and strategy through four perspectives and understanding how each perspective is interconnected. This is the twenty-seventh volume of the eBook series containing practical insights on <strong>sales, self-management, marketing, and performance analysis</strong>.<br /><br />
💡 <strong>One-line Knowledge/Trivia:</strong> "Selective Attention: Why We Miss Important Things" explains the phenomenon where we must choose what to focus our attention on because we cannot process multiple pieces of information simultaneously. In this process, we miss important information or fail to recognize unexpected events. This phenomenon is called selective attention or attentional blindness. Our brain selectively focuses attention to efficiently use limited cognitive resources, but this causes us to miss information. It covers in detail the concept of selective attention, its causes, real-life examples in various situations such as the gorilla experiment, using mobile phones while driving, and multitasking, and methods to address it.<br /><br />
