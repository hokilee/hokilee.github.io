...
const translations = {
  ko: {
    ...
    'notice.updateContent20251219': `<strong>2025-12-19</strong> - eBook Series 게시판과 경제상식 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.26 — 성과관리의 진화 — KPI에서 BSC로, 균형 잡힌 조직의 조건」가 업데이트되었습니다. 단순한 KPI 중심의 성과관리를 넘어 균형잡힌 성과관리 체계인 BSC(Balanced Scorecard)로의 진화에 대한 내용을 담고 있습니다. 재무, 고객, 내부 프로세스, 학습과 성장의 네 가지 관점을 통합하여 조직의 전략을 실행하고 성과를 측정하는 방법을 다룹니다. 단순히 재무 지표만으로 평가하는 것이 아니라, 고객 만족도, 내부 프로세스 효율성, 조직의 학습과 성장까지 종합적으로 평가하는 균형잡힌 성과관리 체계를 구축하는 방법을 제시합니다. <strong>영업, 자기관리, 마케팅, 성과 분석</strong> 등 실무 인사이트를 담은 eBook 시리즈 스물여섯 번째 자료입니다.<br /><br />
💼 <strong>경제상식:</strong> 「비정규직과 정규직, 고용 형태가 경제에 미치는 영향」에서는 한국의 고용 시장에서 비정규직과 정규직의 구분이 단순한 고용 형태의 차이를 넘어, 개인의 소득과 소비, 그리고 전체 경제 구조에 큰 영향을 미치는 것을 설명합니다. 비정규직의 증가는 기업의 인건비 절감과 유연한 인력 운영을 가능하게 하지만, 동시에 소득 불안정, 소비 위축, 경제 성장 둔화 등의 문제를 야기합니다. 고용 형태의 차이, 비정규직 증가의 원인, 고용 형태가 경제에 미치는 영향, 그리고 개인과 기업, 정부의 대응 방안을 상세히 다룹니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251219': `<strong>2025-12-19</strong> – We've added new content to the eBook Series board and Economics board.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.26 — The Evolution of Performance Management — From KPI to BSC: Conditions for a Balanced Organization" has been updated. This volume covers the evolution from simple KPI-centered performance management to a balanced performance management system called BSC (Balanced Scorecard). It explores how to execute organizational strategy and measure performance by integrating four perspectives: financial, customer, internal processes, and learning and growth. Rather than evaluating performance solely through financial indicators, it presents methods to build a balanced performance management system that comprehensively evaluates customer satisfaction, internal process efficiency, and organizational learning and growth. This is the twenty-sixth volume of the eBook series containing practical insights on <strong>sales, self-management, marketing, and performance analysis</strong>.<br /><br />
💼 <strong>Economics:</strong> "Regular and Non-regular Employment: How Employment Types Affect the Economy" explains that in Korea's labor market, the distinction between regular and non-regular employment goes beyond simple differences in employment types, significantly impacting individual income, consumption, and the overall economic structure. While the increase in non-regular employment enables companies to reduce labor costs and operate flexibly, it also causes problems such as income instability, consumption contraction, and economic growth slowdown. It covers in detail the differences in employment types, causes of the increase in non-regular employment, how employment types affect the economy, and response strategies for individuals, companies, and the government.<br /><br />
