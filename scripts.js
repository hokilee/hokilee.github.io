...
const translations = {
  ko: {
    ...
    'notice.updateContent20251226': `<strong>2025-12-26</strong> - eBook Series 게시판과 한줄 지식/잡학 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.30 — 성과목표 중심의 전략적 성과경영 — 실행력을 높이는 3단계 성과 프로세스」가 업데이트되었습니다. 성과목표를 중심으로 한 전략적 성과경영의 핵심을 다룹니다. 단순히 목표를 설정하는 것을 넘어, 실행력을 높이는 3단계 성과 프로세스를 통해 조직의 성과를 체계적으로 관리하고 향상시키는 방법을 제시합니다. 목표 설정부터 실행, 평가, 개선까지의 전 과정을 통합적으로 관리하는 전략적 접근법을 다룹니다. <strong>성과관리, 전략 실행, 목표 달성, 조직 운영</strong> 등 실무 인사이트를 담은 eBook 시리즈 서른 번째 자료입니다.<br /><br />
💡 <strong>한줄 지식/잡학:</strong> 「소형 언어 모델(SLM)의 부상, AI 트렌드와 실용성」은 ChatGPT나 Claude 같은 대규모 언어 모델(LLM)에 비해 파라미터 수가 적고 연산 자원이 적게 드는 소형 언어 모델(SLM)의 특징과 활용을 다룹니다. 비용 효율성과 실용성 측면에서 강점을 보이는 SLM은 모바일 기기나 엣지 디바이스에서도 실행 가능하여 활용 범위가 넓습니다. 특히 도메인 특화 모델이나 개인화된 서비스에서 SLM의 장점이 두드러집니다. 소형 언어 모델의 개념, 특징, 활용 사례, 그리고 미래 전망을 상세히 다룹니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251226': `<strong>2025-12-26</strong> – We've added new content to the eBook Series board and One-Line Knowledge/Trivia board.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.30 — Strategic Performance Management Centered on Performance Goals — A 3-Step Performance Process to Enhance Execution" has been updated. It covers the core of strategic performance management centered on performance goals. Beyond simply setting goals, it presents methods to systematically manage and improve organizational performance through a 3-step performance process that enhances execution. It covers a strategic approach to comprehensively managing the entire process from goal setting to execution, evaluation, and improvement. This is the thirtieth volume of the eBook series containing practical insights on <strong>performance management, strategy execution, goal achievement, and organizational operations</strong>.<br /><br />
💡 <strong>One-Line Knowledge/Trivia:</strong> "The Rise of Small Language Models (SLM) — AI Trends and Practicality" covers the characteristics and applications of Small Language Models (SLM), which have fewer parameters and require less computational resources compared to Large Language Models (LLM) like ChatGPT or Claude. SLM, which shows strengths in cost efficiency and practicality, can run on mobile devices or edge devices, expanding its range of applications. The advantages of SLM are particularly prominent in domain-specific models or personalized services. It covers in detail the concept, characteristics, application cases, and future prospects of small language models.<br /><br />
