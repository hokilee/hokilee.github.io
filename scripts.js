...
const translations = {
  ko: {
    ...
    'schedule.item1.title':
      'ARC Industry Leadership Forum 2026 개막 - 산업 AI 및 디지털 전환',
    'schedule.item1.content':
      'ARC Industry Leadership Forum 2026이 오늘부터 12일까지(미국 동부 시간 기준) 미국 플로리다 오를랜도 Renaissance Orlando at SeaWorld에서 개최됩니다. 오늘 개막일에는 오전 8시부터 오후 6시까지 등록 및 오리엔테이션이 진행되며, 오전 9시부터 오후 5시까지는 산업 AI, IIoT 아키텍처, 디지털 전환, OT 전략에 대한 키노트 세션과 워크샵이 열립니다. 제조업, 에너지, 인프라, 공급망 리더와 기술 전문가 700명 이상이 참석하며, 자동차 제조업의 디지털 전환, 스마트 팩토리 구축, 산업 AI 적용 사례, IIoT 아키텍처 설계, 사이버보안 전략 등이 주요 논의 주제입니다. 자동차 제조사, 부품 기업, IT 솔루션 제공업체, 연구기관이 참석합니다.',
    'schedule.item2.title':
      '자동차 사이버보안 워크샵 2026 - 차량 네트워크 보안 강화',
    'schedule.item2.content':
      '자동차 사이버보안 워크샵 2026이 오늘 오전 10시부터 오후 5시까지(한국 시간) 서울 강남구 코엑스에서 개최됩니다. 최근 Pwn2Own Automotive 2026에서 발견된 76개의 제로데이 취약점을 바탕으로 차량 네트워크 보안 강화 방안, 소프트웨어 정의 차량(SDV) 보안 아키텍처, OTA 업데이트 보안, 차량 내 보안 게이트웨이 구축, 실시간 위협 탐지 시스템 등이 주요 논의 주제입니다. ISO/SAE 21434 자동차 사이버보안 표준 준수 방안, 인포테인먼트 시스템 보안, 전기차 충전 인프라 보안, V2X 통신 보안 등도 다뤄집니다. 자동차 제조사, 부품 기업, 사이버보안 솔루션 제공업체, 연구기관이 참석합니다.',
    'schedule.item3.title':
      '소프트웨어 정의 차량(SDV) 개발자 포럼 2026',
    'schedule.item3.content':
      '소프트웨어 정의 차량(SDV) 개발자 포럼 2026이 오늘 오전 9시부터 오후 4시까지(한국 시간) 서울 여의도에서 개최됩니다. HERE Technologies, HARMAN, Qorix 등의 SDV 솔루션을 바탕으로 SDV 아키텍처 설계, 차량용 소프트웨어 플랫폼 개발, AI 기반 차량 서비스 통합, OTA 업데이트 시스템 구축, 차량 내 고성능 컴퓨팅 등이 주요 논의 주제입니다. SDV 미들웨어 개발, 차량용 소프트웨어 개발 키트(SDK), 차량 내 하이퍼바이저 기술, 검증 및 테스트 도구 등도 다뤄집니다. 자동차 제조사, 소프트웨어 개발 기업, IT 솔루션 제공업체, 개발자 커뮤니티가 참석합니다.',
    'schedule.item4.title':
      '자율주행 기술 상용화 전략 세미나 2026',
    'schedule.item4.content':
      '자율주행 기술 상용화 전략 세미나 2026이 오늘 오전 10시부터 오후 4시까지(한국 시간) 서울 강남구에서 개최됩니다. 테슬라의 FSD 기술 확대, 웨이모의 로봇택시 서비스 확대, 포드의 레벨 3 자율주행 계획 등을 바탕으로 자율주행 기술 상용화 로드맵, 자율주행 로봇택시 서비스 운영 전략, 자율주행 기술의 안전성 검증, 법적 프레임워크 구축 등이 주요 논의 주제입니다. 레벨 3-4 자율주행 기술, 자율주행 시뮬레이션 기술, V2X 통신 기반 협력 자율주행, 자율주행 기술의 글로벌 시장 진출 전략 등도 다뤄집니다. 자동차 제조사, 자율주행 기술 기업, 연구기관, 규제 기관이 참석합니다.',
    'schedule.item5.title':
      '자동차용 반도체 공급 안정성 대응 전략 워크샵',
    'schedule.item5.content':
      '자동차용 반도체 공급 안정성 대응 전략 워크샵이 오늘 오후 1시부터 5시까지(한국 시간) 서울 강남구에서 개최됩니다. AI 데이터센터의 반도체 수요 급증으로 인한 자동차용 반도체 공급 부족 문제를 바탕으로 반도체 공급망 다각화 전략, 자동차용 반도체의 장기 공급 계약, 통합 프로세서 도입 전략, 반도체 파운드리와의 협력 방안 등이 주요 논의 주제입니다. NXP의 S32N7 슈퍼 통합 프로세서와 같은 통합 솔루션 도입, 자동차용 반도체의 설계 최적화, 반도체 공급 부족에 대비한 생산 계획 수립 등도 다뤄집니다. 자동차 제조사, 반도체 기업, 부품 기업, 공급망 관리 전문가가 참석합니다.',
    'notice.updateContent20260209': `<strong>2026-02-09</strong> - eBook Series 게시판과 기술 트렌드/뉴스 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「조직문화는 설계된다」 시리즈의 제5장 「조직문화는 운영되지 않으면 사라진다」가 연재되었습니다. 조직문화는 한 번 만들면 끝나는 것이 아니라 지속적으로 운영하고 관리해야 합니다. 이 장에서는 조직문화가 운영되지 않으면 어떻게 사라지는지, 조직문화 운영의 중요성, 조직문화를 지속적으로 유지하고 강화하는 방법 등을 심층적으로 분석합니다. 조직문화는 방치하면 자연스럽게 약해지고 사라지며, 부정적인 문화로 대체될 수 있습니다. 조직문화를 유지하기 위해서는 지속적인 관심과 노력이 필요하며, 조직문화를 운영하는 체계적인 프로세스가 필요합니다. 조직문화는 설계하는 것만으로는 충분하지 않으며, 운영하는 것이 더 중요합니다. 진정한 조직문화를 만들기 위해서는 조직문화를 지속적으로 운영하고 관리하는 시스템을 구축해야 하며, 조직문화 운영이 조직문화의 생명력을 결정합니다.<br /><br />
📰 <strong>기술 트렌드/뉴스:</strong> 「2026년 1월 29일~2월 6일 기술 트렌드/뉴스」가 추가되었습니다. 이번 기간 기술 트렌드는 자동차 사이버보안의 심각성이 대두되면서 산업 전반의 보안 강화 움직임이 본격화되었습니다. Pwn2Own Automotive 2026에서 76개의 제로데이 취약점이 발견되며 자동차 보안의 취약성이 드러났고, 테슬라가 플래그십 모델을 중단하고 자율주행과 로봇 기술에 집중하는 전략적 전환을 발표했습니다. 자동차 산업은 전기차 중심에서 AI와 자율주행 기술 중심으로 전환되며, 주요 제조사들이 소프트웨어 정의 차량(SDV) 기술 개발에 집중하고 있습니다. 반면 AI 데이터센터의 반도체 수요 급증으로 자동차용 반도체 공급 부족이 심화되며, 자동차 생산에 영향을 미칠 것으로 전망됩니다. 소프트웨어 정의 차량 기술의 발전과 함께 사이버보안 강화가 필수 과제로 부상했습니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'schedule.item1.title':
      'ARC Industry Leadership Forum 2026 Opening - Industrial AI & Digital Transformation',
    'schedule.item1.content':
      'ARC Industry Leadership Forum 2026 will be held from today through February 12 (US Eastern Time) at Renaissance Orlando at SeaWorld in Orlando, Florida, USA. Today\'s opening day features registration and orientation from 8:00 AM to 6:00 PM, with keynote sessions and workshops on industrial AI, IIoT architecture, digital transformation, and OT strategy running from 9:00 AM to 5:00 PM. Over 700 manufacturing, energy, infrastructure, supply-chain leaders, and technology experts will attend. Key topics include digital transformation in automotive manufacturing, smart factory construction, industrial AI application cases, IIoT architecture design, and cybersecurity strategies. Automakers, parts companies, IT solution providers, and research institutions will attend.',
    'schedule.item2.title':
      'Automotive Cybersecurity Workshop 2026 - Vehicle Network Security Enhancement',
    'schedule.item2.content':
      'The Automotive Cybersecurity Workshop 2026 will be held today from 10:00 AM to 5:00 PM (Korea time) at COEX in Gangnam-gu, Seoul. Based on the 76 zero-day vulnerabilities discovered at Pwn2Own Automotive 2026, key topics include vehicle network security enhancement measures, Software-Defined Vehicle (SDV) security architecture, OTA update security, in-vehicle security gateway construction, and real-time threat detection systems. ISO/SAE 21434 automotive cybersecurity standard compliance measures, infotainment system security, EV charging infrastructure security, and V2X communication security are also discussed. Automakers, parts companies, cybersecurity solution providers, and research institutions will attend.',
    'schedule.item3.title':
      'Software-Defined Vehicle (SDV) Developer Forum 2026',
    'schedule.item3.content':
      'The Software-Defined Vehicle (SDV) Developer Forum 2026 will be held today from 9:00 AM to 4:00 PM (Korea time) in Yeouido, Seoul. Based on SDV solutions from HERE Technologies, HARMAN, and Qorix, key topics include SDV architecture design, vehicle software platform development, AI-based vehicle service integration, OTA update system construction, and in-vehicle high-performance computing. SDV middleware development, vehicle software development kits (SDK), in-vehicle hypervisor technology, and validation and testing tools are also discussed. Automakers, software development companies, IT solution providers, and developer communities will attend.',
    'schedule.item4.title':
      'Autonomous Driving Technology Commercialization Strategy Seminar 2026',
    'schedule.item4.content':
      'The Autonomous Driving Technology Commercialization Strategy Seminar 2026 will be held today from 10:00 AM to 4:00 PM (Korea time) in Gangnam-gu, Seoul. Based on Tesla\'s FSD technology expansion, Waymo\'s robotaxi service expansion, and Ford\'s Level 3 autonomous driving plans, key topics include autonomous driving technology commercialization roadmaps, autonomous robotaxi service operation strategies, autonomous driving technology safety verification, and legal framework construction. Level 3-4 autonomous driving technologies, autonomous driving simulation technologies, V2X communication-based cooperative autonomous driving, and global market entry strategies for autonomous driving technologies are also discussed. Automakers, autonomous driving technology companies, research institutions, and regulatory agencies will attend.',
    'schedule.item5.title':
      'Automotive Semiconductor Supply Stability Response Strategy Workshop',
    'schedule.item5.content':
      'The Automotive Semiconductor Supply Stability Response Strategy Workshop will be held today from 1:00 PM to 5:00 PM (Korea time) in Gangnam-gu, Seoul. Based on the automotive semiconductor supply shortage caused by surging demand from AI data centers, key topics include semiconductor supply chain diversification strategies, long-term supply contracts for automotive semiconductors, integrated processor adoption strategies, and cooperation plans with semiconductor foundries. Adoption of integrated solutions such as NXP\'s S32N7 super-integration processor, design optimization for automotive semiconductors, and production planning to prepare for semiconductor supply shortages are also discussed. Automakers, semiconductor companies, parts companies, and supply chain management experts will attend.',
    'notice.updateContent20260209': `<strong>2026-02-09</strong> – We've added new content to the eBook Series board and Tech Trends/News board.<br /><br />
📖 <strong>eBook Series:</strong> Chapter 5 "Organizational Culture Disappears If Not Operated" of the series "Organizational Culture is Designed" has been serialized. Organizational culture is not something that ends once it's created but must be continuously operated and managed. This chapter provides an in-depth analysis of how organizational culture disappears if not operated, the importance of organizational culture operation, and methods to continuously maintain and strengthen organizational culture. If organizational culture is neglected, it naturally weakens and disappears, and can be replaced by negative culture. To maintain organizational culture, continuous attention and effort are needed, and a systematic process for operating organizational culture is required. Organizational culture is not enough just to design it; operating it is more important. To create a true organizational culture, we must build a system that continuously operates and manages organizational culture, and organizational culture operation determines the vitality of organizational culture.<br /><br />
📰 <strong>Tech Trends/News:</strong> "2026 January 29 - February 6 Tech Trends/News" has been added. During this period, the seriousness of automotive cybersecurity emerged, and industry-wide security enhancement movements were initiated. Pwn2Own Automotive 2026 discovered 76 zero-day vulnerabilities, revealing the vulnerability of automotive security, and Tesla announced a strategic shift to discontinue flagship models and focus on autonomous driving and robotics. The automotive industry is shifting from an EV-centric focus to an AI and autonomous driving technology-centric focus, with major manufacturers concentrating on Software-Defined Vehicle (SDV) technology development. However, surging semiconductor demand from AI data centers is intensifying automotive semiconductor supply shortages, which is expected to impact automotive production. Along with the development of software-defined vehicle technology, cybersecurity enhancement has emerged as an essential task.<br /><br />
