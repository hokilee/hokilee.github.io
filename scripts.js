...
const translations = {
  ko: {
    ...
    'notice.updateContent20251216': `<strong>2025-12-16</strong> - eBook Series 게시판, 경제상식 게시판, 일반상식 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.24 — 지표로 소통하는 조직 — 숫자가 언어가 될 때」가 업데이트되었습니다. <strong>영업, 자기관리, 마케팅, 성과 분석</strong> 등 실무 인사이트를 담은 eBook 시리즈 스물네 번째 자료입니다.<br /><br />
💼 <strong>경제상식:</strong> 「소비 트렌드 변화, MZ세대의 소비 패턴과 경제 영향」에서는 MZ세대(밀레니얼과 Z세대)가 현재 소비 시장의 핵심 주체로 자리잡았으며, 이들의 소비 패턴이 기존 세대와 확연히 다르며 전체 경제 구조에 큰 영향을 미치고 있음을 설명합니다. 소유보다 경험을 중시하고, 디지털 네이티브로서 온라인 소비에 익숙하며, 가치 소비와 개인화를 추구하는 MZ세대의 소비 트렌드는 기업의 마케팅 전략부터 산업 구조까지 변화시키고 있습니다. MZ세대의 소비 패턴의 특징, 변화, 그리고 이러한 변화가 경제에 미치는 영향을 상세히 다룹니다.<br /><br />
📚 <strong>일반상식:</strong> 「파킨슨의 법칙(Parkinson's Law)」은 "일은 주어진 시간을 모두 채우도록 확장된다"는 현상을 설명하는 법칙입니다. 1955년 영국의 역사학자 시릴 노스코트 파킨슨이 제안한 이 법칙은 업무 효율성과 시간 관리에 대한 중요한 통찰을 제공합니다. 예를 들어, 1시간이면 끝낼 수 있는 일도 하루 종일 시간이 주어지면 하루 종일 걸리게 되고, 3일이면 끝낼 수 있는 프로젝트도 일주일이 주어지면 일주일이 걸리게 됩니다. 파킨슨의 법칙의 개념, 발생 원인, 실생활 예시, 그리고 대응 방법을 상세히 다룹니다.<br /><br />
...
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251216': `<strong>2025-12-16</strong> – We've added new content to the eBook Series board, Economics board, and General Knowledge board.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.24 — Organizations That Communicate Through Metrics — When Numbers Become Language" has been updated. This is the twenty-fourth volume of the eBook series containing practical insights on <strong>sales, self-management, marketing, and performance analysis</strong>.<br /><br />
💼 <strong>Economics:</strong> "Changes in Consumption Trends: MZ Generation's Consumption Patterns and Economic Impact" explains that the MZ generation (Millennials and Gen Z) has become the core players in the current consumption market, and their consumption patterns are distinctly different from previous generations, significantly impacting the overall economic structure. The MZ generation values experiences over ownership, is familiar with online consumption as digital natives, and pursues value-based consumption and personalization. Their consumption trends are transforming everything from corporate marketing strategies to industrial structures. It covers in detail the characteristics of the MZ generation's consumption patterns, changes, and how these changes affect the economy.<br /><br />
📚 <strong>General Knowledge:</strong> "Parkinson's Law" is a principle that explains the phenomenon where "work expands to fill the time available for its completion." Proposed in 1955 by British historian Cyril Northcote Parkinson, this law provides important insights into work efficiency and time management. For example, work that could be completed in one hour will take a full day if given a full day, and a project that could be finished in three days will take a week if given a week. It covers in detail the concept of Parkinson's Law, its causes, real-life examples, and methods to address it.<br /><br />
