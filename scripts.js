...
const translations = {
  ko: {
    ...
    'notice.updateContent20251224': `<strong>2025-12-24</strong> - eBook Series 게시판과 일반상식 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.29 — 역할 중심의 수평적 조직경영 — 스스로 움직이는 팀의 구조」가 업데이트되었습니다. 전통적인 위계 중심 조직을 넘어 역할 중심의 수평적 조직 구조를 구축하는 방법을 다룹니다. 각 구성원이 자신의 역할을 명확히 이해하고, 자율적으로 움직일 수 있는 팀 구조를 만드는 것이 핵심입니다. 상명하복의 구조가 아니라, 역할과 책임을 기반으로 한 협력과 자율성을 통해 팀의 성과를 극대화하는 방법을 제시합니다. <strong>영업, 자기관리, 마케팅, 성과 분석</strong> 등 실무 인사이트를 담은 eBook 시리즈 스물아홉 번째 자료입니다.<br /><br />
📚 <strong>일반상식:</strong> 「시그니처 모멘트(Signature Moment)」는 개인의 인생에서 정체성과 자아를 형성하고, 인생의 방향을 결정하는 중요한 순간을 말합니다. 단순한 경험이 아니라, 그 사람의 인생을 정의하는 특별한 순간입니다. 첫사랑, 졸업식, 취업, 결혼 등 인생의 중요한 전환점이 되는 순간들이 시그니처 모멘트가 될 수 있습니다. 이러한 순간들은 매우 생생하게 기억되며, 시간이 지나도 쉽게 잊혀지지 않습니다. 시그니처 모멘트의 개념, 특징, 실생활 예시, 그리고 의미를 상세히 다룹니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251224': `<strong>2025-12-24</strong> – We've added new content to the eBook Series board and General Knowledge board.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.29 — Role-Centered Horizontal Organizational Management — Structure of Self-Moving Teams" has been updated. It covers how to build a role-centered horizontal organizational structure beyond traditional hierarchical organizations. The key is to create a team structure where each member clearly understands their role and can move autonomously. Rather than a top-down structure, it presents methods to maximize team performance through cooperation and autonomy based on roles and responsibilities. This is the twenty-ninth volume of the eBook series containing practical insights on <strong>sales, self-management, marketing, and performance analysis</strong>.<br /><br />
📚 <strong>General Knowledge:</strong> "Signature Moment" refers to important moments in an individual's life that shape their identity and self, and determine the direction of their life. It is not simply an experience, but a special moment that defines that person's life. Moments that become important turning points in life, such as first love, graduation, employment, and marriage, can be signature moments. These moments are remembered very vividly and are not easily forgotten even over time. It covers in detail the concept, characteristics, real-life examples, and meaning of signature moments.<br /><br />
