...
const translations = {
  ko: {
    ...
    'schedule.item1.title': 'SIAT 2026 국제 자동차 기술 심포지엄',
    'schedule.item1.content':
      'SIAT 2026(Symposium of International Automotive Technology 2026)이 오늘부터 30일까지(인도 시간 기준) 인도 푸네 PIECC에서 개최됩니다. "안전하고 지속 가능한 모빌리티를 위한 혁신적 경로"를 주제로 한 이 심포지엄은 14개국 전문가들의 250개 이상의 기술 논문과 키노트를 포함합니다. 전기 모빌리티, 안전, 배출, 자율주행 차량, 사이버보안, AI, 소프트웨어 정의 차량 등을 다루며, 380개 이상의 전시 부스가 있는 SIAT EXPO 2026도 함께 개최됩니다. ARAI와 SAE International, SAE India가 공동 주최하며, 글로벌 자동차 제조사와 기술 기업들이 참석합니다.',
    'schedule.item2.title': '전기차 배터리 기술 혁신 포럼 2026',
    'schedule.item2.content':
      '전기차 배터리 기술 혁신 포럼 2026이 오늘 오전 9시부터 오후 5시까지(한국 시간) 서울 삼성동 코엑스 컨벤션센터에서 개최됩니다. 고용량 배터리 기술, 고속 충전 기술, 배터리 수명 연장 기술, 배터리 재활용 및 순환 경제, 차세대 배터리 소재(고체 전해질, 리튬-황 등) 등이 주요 논의 주제입니다. 현대자동차, 기아, LG에너지솔루션, SK온, 삼성SDI 등 자동차 제조사와 배터리 기업, 소재 기업이 참석하여 전기차 배터리 기술의 최신 동향과 미래 전망을 논의합니다.',
    'schedule.item3.title': '자동차 사이버보안 글로벌 컨퍼런스 2026',
    'schedule.item3.content':
      '자동차 사이버보안 글로벌 컨퍼런스 2026이 오늘부터 29일까지(미국 서부 시간 기준) 미국 실리콘밸리에서 개최됩니다. 차량 네트워크 보안, ECU 보안, OTA 업데이트 보안, 자율주행 차량 보안, V2X 통신 보안, 차량 해킹 대응 전략 등이 주요 논의 주제입니다. ISO 21434 자동차 사이버보안 표준, 차량 보안 아키텍처 설계, 보안 테스트 및 인증, 사이버보안 사고 대응 등 실무 중심의 세션이 진행됩니다. 글로벌 자동차 제조사, 보안 기업, 규제 기관이 참석합니다.',
    'schedule.item4.title': '자율주행 차량 AI 알고리즘 워크샵 2026',
    'schedule.item4.content':
      '자율주행 차량 AI 알고리즘 워크샵 2026이 오늘 오후 1시부터 6시까지(한국 시간) 서울 강남구 테헤란로에서 개최됩니다. 딥러닝 기반 객체 인식, 센서 융합 알고리즘, 경로 계획 및 제어 알고리즘, 실시간 의사결정 AI, 시뮬레이션 기반 학습 등이 주요 논의 주제입니다. 실제 도로 데이터를 활용한 AI 모델 학습 방법, 엣지 AI를 활용한 실시간 추론 최적화, 자율주행 차량의 안전성 검증 방법 등 실무 중심의 기술 세션이 진행됩니다. 현대자동차, 네이버, 카카오모빌리티, AI 스타트업, 대학 연구진이 참석합니다.',
    'schedule.item5.title': '차량 연결성 및 V2X 기술 세미나 2026',
    'schedule.item5.content':
      '차량 연결성 및 V2X 기술 세미나 2026이 오늘 오전 10시부터 오후 4시까지(한국 시간) 서울 여의도에서 개최됩니다. 5G 및 6G 기반 차량 통신, V2V(차량 간 통신), V2I(차량-인프라 통신), V2N(차량-네트워크 통신), V2P(차량-보행자 통신) 기술, 차량 클라우드 연동, 엣지 컴퓨팅을 활용한 차량 서비스 등이 주요 논의 주제입니다. 스마트 시티와의 연계, 실시간 교통 정보 공유, 자율주행 차량 간 협력 주행, 차량 보안 및 프라이버시 보호 등도 다룹니다. 통신사, 자동차 제조사, 인프라 기업, 정부 기관이 참석합니다.',
    'notice.updateContent20260128': `<strong>2026-01-28</strong> - eBook Series 게시판과 경제상식 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「멘토·멘티 제도가 형식으로 끝나는 이유_제4장」이 업데이트되었습니다. 이 장에서는 많은 조직에서 멘토·멘티 제도가 형식적으로 운영되어 실질적인 효과를 거두지 못하는 이유를 심층적으로 분석합니다. 멘토·멘티 제도의 본질적 목적과 기대 효과, 제도 도입 시 발생하는 일반적인 문제점, 멘토와 멘티의 역할과 책임이 불명확한 경우의 문제, 그리고 제도가 형식으로 전락하는 과정을 상세히 설명합니다. 효과적인 멘토·멘티 제도를 구축하기 위한 실무 전략과 성공 사례를 제시합니다.<br /><br />
💰 <strong>경제상식:</strong> 「기술 투자(특히 AI)가 글로벌 성장 동력이 되는 이유」가 추가되었습니다. 최근 글로벌 경제는 보호무역주의 확산과 지정학적 리스크에도 불구하고 지속적인 성장을 보이고 있으며, 기술 투자, 특히 인공지능(AI) 투자가 주요 동력으로 작용하고 있습니다. 생산성 향상 효과, 혁신과 새로운 시장 창출, 비용 절감 효과, 그리고 글로벌 스필오버 효과를 통해 기술 투자가 어떻게 경제 성장을 촉진하는지, 그리고 이러한 투자가 경제에 미치는 다양한 영향을 자세히 알아볼 수 있습니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'schedule.item1.title': 'SIAT 2026 International Automotive Technology Symposium',
    'schedule.item1.content':
      'SIAT 2026 (Symposium of International Automotive Technology 2026) will be held from today through January 30 (India time) at PIECC in Pune, India. With the theme "Innovative Pathways for Safe and Sustainable Mobility", this symposium features over 250 technical papers and keynotes from experts in 14 countries. The event covers electric mobility, safety, emissions, autonomous vehicles, cybersecurity, AI, software-defined vehicles, and more. SIAT EXPO 2026 with over 380 exhibition stalls will also be held concurrently. Co-hosted by ARAI, SAE International, and SAE India, global automakers and technology companies will attend.',
    'schedule.item2.title': 'EV Battery Technology Innovation Forum 2026',
    'schedule.item2.content':
      'The EV Battery Technology Innovation Forum 2026 will be held today from 9:00 AM to 5:00 PM (Korea time) at COEX Convention Center in Samseong-dong, Seoul. Key topics include high-capacity battery technology, fast-charging technology, battery lifespan extension technology, battery recycling and circular economy, and next-generation battery materials (solid electrolytes, lithium-sulfur, etc.). Automakers such as Hyundai Motor and Kia, battery companies including LG Energy Solution, SK On, and Samsung SDI, along with materials companies, will attend to discuss the latest trends and future prospects of EV battery technology.',
    'schedule.item3.title': 'Automotive Cybersecurity Global Conference 2026',
    'schedule.item3.content':
      'The Automotive Cybersecurity Global Conference 2026 will be held from today through January 29 (US Pacific Time) in Silicon Valley, USA. Key topics include vehicle network security, ECU security, OTA update security, autonomous vehicle security, V2X communication security, and vehicle hacking response strategies. Practical sessions will cover ISO 21434 automotive cybersecurity standards, vehicle security architecture design, security testing and certification, and cybersecurity incident response. Global automakers, security companies, and regulatory agencies will attend.',
    'schedule.item4.title': 'Autonomous Vehicle AI Algorithm Workshop 2026',
    'schedule.item4.content':
      'The Autonomous Vehicle AI Algorithm Workshop 2026 will be held today from 1:00 PM to 6:00 PM (Korea time) on Teheran-ro in Gangnam-gu, Seoul. Key topics include deep learning-based object recognition, sensor fusion algorithms, path planning and control algorithms, real-time decision-making AI, and simulation-based learning. Practical technical sessions will cover AI model training methods using real road data, real-time inference optimization using edge AI, and safety verification methods for autonomous vehicles. Hyundai Motor, Naver, Kakao Mobility, AI startups, and university researchers will attend.',
    'schedule.item5.title': 'Vehicle Connectivity & V2X Technology Seminar 2026',
    'schedule.item5.content':
      'The Vehicle Connectivity & V2X Technology Seminar 2026 will be held today from 10:00 AM to 4:00 PM (Korea time) in Yeouido, Seoul. Key topics include 5G and 6G-based vehicle communication, V2V (vehicle-to-vehicle), V2I (vehicle-to-infrastructure), V2N (vehicle-to-network), V2P (vehicle-to-pedestrian) technologies, vehicle-cloud integration, and vehicle services using edge computing. The seminar will also cover integration with smart cities, real-time traffic information sharing, cooperative driving between autonomous vehicles, and vehicle security and privacy protection. Telecommunications companies, automakers, infrastructure companies, and government agencies will attend.',
    'notice.updateContent20260128': `<strong>2026-01-28</strong> – We've added new content to the eBook Series board and Economics Knowledge board.<br /><br />
📖 <strong>eBook Series:</strong> "Why Mentor-Mentee Programs End Up Being Formal — Chapter 4" has been updated. This chapter provides an in-depth analysis of why mentor-mentee programs in many organizations end up being formal and fail to achieve substantial results. It covers the essential purpose and expected effects of mentor-mentee programs, common problems that arise when implementing such programs, issues when the roles and responsibilities of mentors and mentees are unclear, and the process by which programs become mere formalities. It presents practical strategies and success cases for building effective mentor-mentee programs.<br /><br />
💰 <strong>Economics Knowledge:</strong> "Why Technology Investment (Especially AI) Becomes a Global Growth Driver" has been added. Despite the spread of protectionism and geopolitical risks, the global economy continues to show sustained growth, with technology investment, particularly artificial intelligence (AI) investment, serving as a key driver. You can learn in detail about how technology investment promotes economic growth through productivity enhancement effects, innovation and new market creation, cost reduction effects, and global spillover effects, as well as the various impacts such investment has on the economy.<br /><br />
