...
const translations = {
  ko: {
    ...
    'notice.updateContent20251208': `<strong>2025-12-08</strong> - 경제상식 게시판, 일반상식 게시판, 기술 트렌드/뉴스 게시판과 eBook Series 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
💼 <strong>경제상식:</strong> 「고환율 시대, 해외여행과 해외쇼핑의 경제학」에서는 최근 원·달러 환율이 1,470원대까지 상승하면서 해외여행과 해외쇼핑에 미치는 영향을 분석합니다. 환율이 오르면 해외여행 비용이 증가하고, 해외직구나 해외쇼핑의 가격도 변동하게 됩니다. 환율의 개념과 변동 원인, 고환율이 해외여행과 해외쇼핑에 미치는 영향, 환율과 수출·수입의 관계, 환율 변동에 대응하는 실전 팁, 환율과 개인 자산 관리, 환율 전망과 경제 전망 등을 상세히 설명합니다. 환율은 단순히 숫자의 변화가 아니라 우리의 일상생활과 경제 활동에 직접적인 영향을 미치는 중요한 경제 지표입니다.<br /><br />
📚 <strong>일반상식:</strong> 「확증편향(Confirmation Bias)」에서는 사람들이 자신의 기존 신념, 가설, 또는 가정을 지지하거나 확인하는 정보를 찾고, 기억하고, 해석하는 경향을 선호하는 인지적 편향을 설명합니다. 반대로 자신의 신념과 모순되거나 반대되는 정보는 무시하거나 낮게 평가하는 경향이 있습니다. 확증편향은 인간의 사고 과정에서 매우 흔하게 나타나는 현상으로, 과학적 연구, 의사결정, 투자, 정치, 일상생활 등 다양한 영역에서 영향을 미칩니다. 확증편향의 개념, 발생 원인, 실생활에서의 영향, 그리고 극복 방안을 자세히 다룹니다.<br /><br />
📰 <strong>기술 트렌드/뉴스:</strong> 「2025년 11월 4주차~12월 1주차 기술 트렌드/뉴스」에서는 자동차, IT, 반도체 등 다양한 기술 분야의 최신 동향과 뉴스를 다룹니다. 급변하는 기술 환경에서 최신 트렌드를 파악하는 것은 매우 중요합니다. 이번 자료에서는 각 분야의 주요 기술 발전, 시장 동향, 기업 동향 등을 종합적으로 정리하여 제공합니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.18 — 성과를 읽는 조직 — 프로세스의 결과를 확인하고 정리하는 법」가 업데이트되었습니다. <strong>영업, 자기관리, 마케팅, 성과 분석</strong> 등 실무 인사이트를 담은 eBook 시리즈 열여덟 번째 자료입니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
    'notice.updateContent20251205': `<strong>2025-12-05</strong> - 한줄 지식/잡학 게시판과 eBook Series 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
💡 <strong>한줄 지식/잡학:</strong> 「지구의 중력은 균일하지 않다, 중력 이상 지역」에서는 우리가 학교에서 배운 것처럼 지구의 중력가속도가 일정하지 않다는 사실을 설명합니다. 실제로 지구의 중력은 지각의 밀도, 지형의 높이, 지하 자원의 분포, 지구의 자전 등 다양한 요인에 의해 지역별로 차이가 있습니다. 허드슨만(캐나다)은 세계에서 중력이 가장 약한 지역 중 하나이며, 안데스 산맥은 높은 지형에도 불구하고 지하의 밀도 높은 암석으로 인해 중력이 강한 지역입니다. 이러한 중력의 차이는 GPS 시스템, 항공기 비행, 지하 자원 탐사, 지진 연구, 기후 변화 연구 등 실생활에도 중요한 영향을 미칩니다. 중력 이상 지역의 원인과 세계의 대표적인 중력 이상 지역, 중력 측정 방법, 그리고 실생활에 미치는 영향을 상세히 설명합니다.<br /><br />
📖 <strong>eBook Series:</strong> 「Hoki Lee eBook Series Vol.16 — 실행이 문화를 완성한다 — 프로세스는 행동으로 증명된다」가 업데이트되었습니다. <strong>영업, 자기관리, 마케팅, 성과 분석</strong> 등 실무 인사이트를 담은 eBook 시리즈 열여섯 번째 자료입니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
...
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251208': `<strong>2025-12-08</strong> – We've added new content to the Economics board, General Knowledge board, Tech Trends/News board, and eBook Series board.<br /><br />
💼 <strong>Economics:</strong> "High Exchange Rate Era: The Economics of Overseas Travel and Shopping" analyzes the impact on overseas travel and shopping as the KRW-USD exchange rate has recently risen to around 1,470 won. When the exchange rate rises, overseas travel costs increase, and prices for overseas direct purchases and shopping also fluctuate. It explains in detail the concept and causes of exchange rate fluctuations, the impact of high exchange rates on overseas travel and shopping, the relationship between exchange rates and exports/imports, practical tips for responding to exchange rate fluctuations, exchange rates and personal asset management, and exchange rate outlook and economic forecasts. Exchange rates are not just numerical changes but important economic indicators that directly affect our daily lives and economic activities.<br /><br />
📚 <strong>General Knowledge:</strong> "Confirmation Bias" explains the cognitive bias where people prefer to seek, remember, and interpret information that supports or confirms their existing beliefs, hypotheses, or assumptions. Conversely, there is a tendency to ignore or undervalue information that contradicts or opposes one's beliefs. Confirmation bias is a very common phenomenon in human thought processes, affecting various areas such as scientific research, decision-making, investment, politics, and daily life. It covers in detail the concept of confirmation bias, its causes, its impact on daily life, and methods to overcome it.<br /><br />
📰 <strong>Tech Trends/News:</strong> "Tech Trends/News for November 4th Week ~ December 1st Week, 2025" covers the latest trends and news in various technology fields such as automotive, IT, and semiconductors. Understanding the latest trends in a rapidly changing technological environment is very important. This material comprehensively organizes and provides major technological developments, market trends, and corporate trends in each field.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.18 — Organizations That Read Performance — How to Verify and Organize Process Results" has been updated. This is the eighteenth volume of the eBook series containing practical insights on <strong>sales, self-management, marketing, and performance analysis</strong>.<br /><br />
Please check each board for more detailed content.`,
    'notice.updateContent20251205': `<strong>2025-12-05</strong> – We've added new content to the One-line Knowledge/Trivia board and eBook Series board.<br /><br />
💡 <strong>One-line Knowledge/Trivia:</strong> "Earth's Gravity is Not Uniform: Gravity Anomaly Regions" explains the fact that Earth's gravitational acceleration is not constant, contrary to what we learned in school. In reality, Earth's gravity varies by region due to various factors such as crust density, terrain height, distribution of underground resources, and Earth's rotation. Hudson Bay (Canada) is one of the regions with the weakest gravity in the world, while the Andes Mountains have strong gravity despite high terrain due to dense underground rocks. These differences in gravity have important impacts on daily life, including GPS systems, aircraft flight, underground resource exploration, earthquake research, and climate change studies. It explains in detail the causes of gravity anomaly regions, representative gravity anomaly regions around the world, methods of measuring gravity, and their impact on daily life.<br /><br />
📖 <strong>eBook Series:</strong> "Hoki Lee eBook Series Vol.16 — Execution Completes Culture — Processes Are Proven by Action" has been updated. This is the sixteenth volume of the eBook series containing practical insights on <strong>sales, self-management, marketing, and performance analysis</strong>.<br /><br />
Please check each board for more detailed content.`,
