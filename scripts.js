...
const translations = {
  ko: {
    ...
    'notice.updateContent20251212': `<strong>2025-12-12</strong> - 경제상식 게시판, 일반상식 게시판, eBook Series 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
...
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'nav.contact': 'Contact',
    'notice.heading': 'Update Contents',
    'notice.updateContent20251212': `<strong>2025-12-12</strong> – We've added new content to the Economics board, General Knowledge board, and eBook Series board.<br /><br />
