...
const translations = {
  ko: {
    ...
    'schedule.item1.title':
      'SEMICON Korea 2026 폐막 - 자동차용 반도체 기술 및 협력 성과',
    'schedule.item1.content':
      'SEMICON Korea 2026이 오늘 폐막합니다(한국 시간). 서울 강남구 코엑스에서 11일부터 13일까지 3일간 개최된 이번 행사는 국내 최대 규모의 반도체 박람회로, 약 550개 업체가 2,411개 부스를 운영했습니다. 오늘 마지막 날에는 자동차용 반도체 기술 세션이 오전 9시부터 오후 4시까지 진행되며, 차량용 반도체 기술 트렌드, 자율주행용 AI 칩셋, 전기차용 전력 반도체, 차량용 메모리 반도체 등이 주요 논의 주제입니다. 삼성전자, SK하이닉스, 엔비디아, 인텔 등 글로벌 칩메이커와 ASML, AMAT 등 주요 소재·부품·장비 기업이 참여했으며, 자동차용 반도체 공급망 안정화, 자동차 제조사와 반도체 기업 간의 전략적 파트너십, 차량용 반도체의 미래 기술 트렌드 등이 논의되었습니다. 반도체 기업, 자동차 제조사, 부품 기업, 연구기관이 참석합니다.',
    'schedule.item2.title':
      'SEMICON Korea 2026 기술 심포지엄 폐막 세션 - AI 시대의 자동차용 반도체',
    'schedule.item2.content':
      'SEMICON Korea 2026 기술 심포지엄 폐막 세션이 오늘 오전 10시부터 오후 3시까지(한국 시간) 서울 강남구 코엑스에서 개최됩니다. "AI가 촉발한 새로운 산업패러다임 속 첨단기술 및 협력"을 주제로 한 폐막 세션이 진행되며, AI 시대의 자동차용 반도체 기술, 자율주행용 AI 칩셋의 미래, 전기차용 전력 반도체의 혁신, 차량용 반도체의 신뢰성 및 안전성 등이 주요 논의 주제입니다. 30여 개의 콘퍼런스에 200여 명의 전문가가 연사로 참여하여 최신 반도체 기술과 시장 동향을 공유했으며, 자동차용 반도체의 신뢰성 요구사항, ISO 26262 자동차 기능 안전 표준 준수 방안, 차량용 반도체의 장기 공급 보장 전략 등도 다뤄집니다. 반도체 설계 기업, 자동차 제조사, 검증 기관, 연구기관이 참석합니다.',
    'schedule.item3.title':
      'SEMICON Korea 2026 전시회 마지막 날 - 자동차용 반도체 장비 및 재료 전시',
    'schedule.item3.content':
      'SEMICON Korea 2026 전시회가 오늘 마지막 날을 맞습니다(한국 시간). 서울 강남구 코엑스에서 11일부터 13일까지 3일간 개최된 이번 전시회에는 550개 이상의 전시업체와 2,411개의 부스가 참여했습니다. 오늘 마지막 날에는 자동차용 반도체 제조 장비, 반도체 재료, 차량용 반도체 테스트 장비, 자동차용 반도체 패키징 기술 등이 전시됩니다. 차량용 반도체의 고신뢰성 제조 기술, 자동차용 반도체의 고온 내구성 재료, 차량용 반도체의 소형화 및 경량화 기술, 자동차용 반도체의 공급망 관리 솔루션 등이 주요 전시 내용입니다. 삼성전자, SK하이닉스, 엔비디아, 인텔 등 글로벌 칩메이커와 ASML, AMAT 등 주요 소재·부품·장비 기업이 참여했으며, 반도체 장비 기업, 재료 기업, 자동차 제조사, 부품 기업이 참석합니다.',
    'schedule.item4.title':
      '한국 자동차 제조사 구정 연휴 대비 무상점검 서비스 마지막 날 - 전국 서비스센터 운영',
    'schedule.item4.content':
      '한국 자동차 제조사 구정 연휴 대비 무상점검 서비스가 오늘 마지막 날을 맞습니다(한국 시간). 한국자동차모빌리티산업협회(KAMA)가 주관하고 현대자동차, 기아, 한국GM, 르노코리아, KG모빌리티 등 5개 완성차 업체가 참여한 이번 무상점검 서비스는 11일부터 13일까지 3일간 전국 서비스센터에서 실시되었습니다. 구정 연휴 전 차량 안전 점검을 위해 엔진 오일, 브레이크 오일, 냉각수, 배터리, 타이어, 브레이크 패드 등 주요 부품을 무상으로 점검했으며, 전기차의 경우 배터리 상태, 충전 시스템, 고전압 부품 안전성 등을 점검했습니다. 하이브리드 차량은 전기 시스템과 내연기관 시스템을 모두 점검했으며, 구정 연휴 기간 안전 운행을 위한 사전 점검으로 고객 편의를 위해 예약 서비스도 제공되었습니다. 자동차 제조사, 서비스센터, 고객이 참여합니다.',
    'schedule.item5.title':
      '한국 자동차 부품 산업 기술 세미나 2026 - 전기차 부품 표준화 및 혁신',
    'schedule.item5.content':
      '한국 자동차 부품 산업 기술 세미나 2026이 오늘 오전 9시부터 오후 4시까지(한국 시간) 서울 여의도에서 개최됩니다. 한국자동차부품협회(KAPA)와 한국자동차부품소재산업기술연구조합이 주최하며, 전기차 부품 표준화, 전기차 배터리 관리 시스템(BMS) 기술, 전기차 충전 시스템 부품, 전기차 모터 및 인버터 기술, 전기차 열관리 시스템 등이 주요 논의 주제입니다. 전기차 부품의 글로벌 표준화 동향, 전기차 부품의 신뢰성 및 안전성, 전기차 부품의 경량화 및 소형화 기술, 전기차 부품의 공급망 안정화 방안 등도 다뤄집니다. 자동차 부품 제조사, 전기차 제조사, 소재 기업, 연구기관이 참석합니다.',
    'notice.updateContent20260213': `<strong>2026-02-13</strong> - 일반상식 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
🧠 <strong>일반상식:</strong> 「샐리의 상자 테스트(Sally–Anne Test)」가 추가되었습니다. 샐리의 상자 테스트는 마음의 이론(Theory of Mind)을 측정하는 가장 유명한 심리학 테스트 중 하나로, 1985년 Simon Baron-Cohen, Alan M. Leslie, Uta Frith가 개발했습니다. 이 테스트는 다른 사람의 마음 상태(믿음, 의도, 감정 등)를 이해하고 추론하는 능력인 마음의 이론을 평가하며, 자폐 스펙트럼 장애(Autism Spectrum Disorder)를 진단하는 데 중요한 도구로 사용되고 있습니다. 샐리의 상자 테스트는 아동의 사회 인지 발달을 이해하는 데 중요한 역할을 하며, 자폐 스펙트럼 장애의 핵심 특징 중 하나인 사회적 상호작용의 어려움을 설명하는 데 도움을 줍니다. 테스트의 개념, 실시 방법, 해석, 변형, 자폐 스펙트럼 장애와의 관계, 임상적 의미, 한계, 교육적 의미, 뇌과학, 미래 전망 등을 상세히 다룹니다. 샐리의 상자 테스트를 이해하는 것은 사회 인지 발달, 자폐 스펙트럼 장애, 사회적 상호작용 등을 이해하는 데 중요한 역할을 하며, 더 나은 진단과 치료를 가능하게 합니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'schedule.item1.title':
      'SEMICON Korea 2026 Closing - Automotive Semiconductor Technology & Cooperation Achievements',
    'schedule.item1.content':
      'SEMICON Korea 2026 closes today (Korea time). Held at COEX in Gangnam-gu, Seoul from February 11-13, this event was Korea\'s largest semiconductor exhibition, with approximately 550 companies operating 2,411 booths. Today\'s final day features an automotive semiconductor technology session running from 9:00 AM to 4:00 PM, covering automotive semiconductor technology trends, AI chipsets for autonomous driving, power semiconductors for EVs, and automotive memory semiconductors. Global chipmakers including Samsung Electronics, SK Hynix, NVIDIA, and Intel, along with major materials, parts, and equipment companies such as ASML and AMAT, participated. Topics discussed include automotive semiconductor supply chain stabilization, strategic partnerships between automakers and semiconductor companies, and future technology trends for automotive semiconductors. Semiconductor companies, automakers, parts companies, and research institutions will attend.',
    'schedule.item2.title':
      'SEMICON Korea 2026 Technology Symposium Closing Session - Automotive Semiconductors in the AI Era',
    'schedule.item2.content':
      'SEMICON Korea 2026 Technology Symposium closing session will be held today from 10:00 AM to 3:00 PM (Korea time) at COEX in Gangnam-gu, Seoul. The closing session focuses on "Advanced Technology and Cooperation in the New Industrial Paradigm Triggered by AI," covering automotive semiconductor technology in the AI era, the future of AI chipsets for autonomous driving, innovations in power semiconductors for EVs, and reliability and safety of automotive semiconductors. Over 200 experts participated as speakers in 30+ conferences, sharing the latest semiconductor technologies and market trends. Topics also include reliability requirements for automotive semiconductors, ISO 26262 automotive functional safety standard compliance measures, and long-term supply assurance strategies for automotive semiconductors. Semiconductor design companies, automakers, verification institutions, and research institutions will attend.',
    'schedule.item3.title':
      'SEMICON Korea 2026 Exhibition Final Day - Automotive Semiconductor Equipment & Materials Display',
    'schedule.item3.content':
      'SEMICON Korea 2026 Exhibition concludes today (Korea time). Held at COEX in Gangnam-gu, Seoul from February 11-13, this exhibition featured over 550 exhibitors and 2,411 booths. Today\'s final day showcases automotive semiconductor manufacturing equipment, semiconductor materials, automotive semiconductor test equipment, and automotive semiconductor packaging technology. Main exhibition highlights include high-reliability manufacturing technology for automotive semiconductors, high-temperature durability materials for automotive semiconductors, miniaturization and lightweight technology for automotive semiconductors, and supply chain management solutions for automotive semiconductors. Global chipmakers including Samsung Electronics, SK Hynix, NVIDIA, and Intel, along with major materials, parts, and equipment companies such as ASML and AMAT, participated. Semiconductor equipment companies, materials companies, automakers, and parts companies will attend.',
    'schedule.item4.title':
      'Korea Automakers Lunar New Year Free Inspection Service Final Day - Nationwide Service Center Operation',
    'schedule.item4.content':
      'Korea Automakers Lunar New Year Free Inspection Service concludes today (Korea time). Organized by the Korea Automobile Manufacturers Association (KAMA) with participation from five automakers including Hyundai Motor, Kia, GM Korea, Renault Korea, and KG Mobility, this free inspection service was held at service centers nationwide from February 11-13. To ensure vehicle safety before the Lunar New Year holiday, major components such as engine oil, brake fluid, coolant, battery, tires, and brake pads were inspected free of charge. For EVs, battery status, charging systems, and high-voltage component safety were inspected, while hybrid vehicles had both electric and internal combustion systems inspected. This pre-inspection service for safe driving during the Lunar New Year holiday also provided reservation services for customer convenience. Automakers, service centers, and customers participated.',
    'schedule.item5.title':
      'Korea Automotive Parts Industry Technology Seminar 2026 - EV Parts Standardization & Innovation',
    'schedule.item5.content':
      'Korea Automotive Parts Industry Technology Seminar 2026 will be held today from 9:00 AM to 4:00 PM (Korea time) in Yeouido, Seoul. Hosted by the Korea Auto Parts Association (KAPA) and the Korea Automotive Parts & Materials Industry Technology Research Consortium, key topics include EV parts standardization, EV battery management system (BMS) technology, EV charging system parts, EV motor and inverter technology, and EV thermal management systems. Global standardization trends for EV parts, reliability and safety of EV parts, lightweight and miniaturization technology for EV parts, and supply chain stabilization measures for EV parts are also discussed. Automotive parts manufacturers, EV manufacturers, materials companies, and research institutions will attend.',
    'notice.updateContent20260213': `<strong>2026-02-13</strong> – We've added new content to the General Knowledge board.<br /><br />
🧠 <strong>General Knowledge:</strong> "Sally–Anne Test" has been added. The Sally–Anne Test is one of the most famous psychological tests for measuring Theory of Mind, developed in 1985 by Simon Baron-Cohen, Alan M. Leslie, and Uta Frith. This test evaluates Theory of Mind, the ability to understand and infer other people's mental states (beliefs, intentions, emotions, etc.), and is an important tool used in diagnosing Autism Spectrum Disorder (ASD). The Sally–Anne Test plays an important role in understanding children's social cognitive development and helps explain one of the core characteristics of Autism Spectrum Disorder: difficulties in social interaction. It covers the test's concept, implementation methods, interpretation, variations, relationship with Autism Spectrum Disorder, clinical significance, limitations, educational implications, neuroscience, and future prospects in detail. Understanding the Sally–Anne Test plays an important role in understanding social cognitive development, Autism Spectrum Disorder, and social interaction, enabling better diagnosis and treatment.<br /><br />
