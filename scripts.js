...
const translations = {
  ko: {
    ...
    'notice.updateContent20260310': `<strong>2026-03-09</strong> - 경제상식 게시판과 오늘의 일정(자동차/IT)을 업데이트했습니다.<br /><br />
...
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'notice.updateContent20260310': `<strong>2026-03-09</strong> – We've updated the Economics board and Today's Schedule (Automotive/IT).<br /><br />
