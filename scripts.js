...
const translations = {
  ko: {
    ...
    'schedule.item1.title':
      'AI & IoT in Connected Vehicles 웨비나 - 연결차량 수익화',
    'schedule.item1.content':
      'AI & IoT in Connected Vehicles 웨비나가 오늘 오전 2시부터 오후 3시까지(한국 시간, EST 12:00-13:00) Zoom으로 온라인 개최됩니다. AutoMobility Advisors와 Devox Software가 주최하며, 연결차량 수익화, 텔레매틱스 데이터를 수익 제품으로 전환하는 사례, EU 데이터법 및 미국 주 개인정보법 규제 압박, 빅테크와 OEM 간 콕핏 경쟁, 예측 정비 SaaS, 구독 모델 성과 등이 주요 논의 주제입니다. 5만 대 연결차량을 운영하는 중장비 OEM의 텔레매틱스 데이터 수익화 사례, 플릿 운영자의 예측 정비 SaaS 확산, 소비자 구독 모델의 저조한 성과 원인 등이 다뤄집니다. 자동차 제조사, Tier 1 공급업체, 모빌리티 플랫폼의 연결 서비스·디지털 제품·수익 전략 담당자가 참석합니다.',
    'schedule.item2.title':
      'AutoSec Europe 2026 - 유럽 자동차 사이버보안·데이터 보안 서밋',
    'schedule.item2.content':
      '제2회 유럽 자동차 사이버보안 및 데이터 보안 서밋(AutoSec Europe 2026)이 오늘부터 3월 20일까지 독일 프랑크푸르트에서 개최됩니다. IoV 공급망 보안 관리, 중국 차량 사이버보안 의무화 요건, 포스트 퀀텀 암호의 자동차 보안 영향, 연결차량 EU AI 사이버보안 표준화, UN R155 준수 과제, 침투 테스트 및 차량-클라우드 보안, AI 기반 위협 분석 및 리스크 평가(TARA), 소프트웨어 정의 차량(SDV) 보안 등이 주요 논의 주제입니다. 2,000명 이상 참가, 50개 이상 자동차 제조사, 40명 이상 전문가가 참석합니다. 자동차 사이버보안 전문가, OEM, 보안 소프트웨어 기업, Tier 1/2 공급업체가 대상입니다.',
    'schedule.item3.title':
      '제16회 Automotive Cybersecurity Summit 2026 - 보안·혁신·ROI 균형',
    'schedule.item3.content':
      '제16회 Automotive Cybersecurity Summit 2026이 오늘(3월 19일, 2일차) 미국 미시간주 앤아버 Sheraton Ann Arbor Hotel에서 개최됩니다. Automotive IQ 주최로, 2026년 테마는 "보안·혁신·ROI 균형"입니다. 제품/차량 보안, IT/OT 보안, 제조 보안, 애플리케이션 보안, 임베디드 보안이 주요 영역이며, AI 기반 사이버 공격, 소프트웨어 정의 차량(SDV), R155 표준 준수, CRA/SBOM/HBOM 요건, 포스트 퀀텀 암호(PQC) 등이 논의됩니다. Stellantis, Ford, Harman, Bosch, Lucid Motors 등 40명 이상 자동차 보안 연사가 발표합니다. 기술 혁신가, 소프트웨어 개발자, 자동차 엔지니어, 사이버보안 전문가가 참석합니다.',
    'schedule.item4.title':
      'Automotive Testing Expo Korea 2026 - 자동차 테스팅 기술 전시회',
    'schedule.item4.content':
      'Automotive Testing Expo Korea 2026이 오늘(3월 19일, 2일차) 킨텍스(KINTEX) 10B홀에서 개최됩니다. 3월 18-20일 일정으로 한국 최대 규모의 자동차 부품 테스팅·개발·검증 기술 국제 행사입니다. ADAS 및 자율주행차 테스트, 전기·하이브리드 파워트레인 테스트, 배터리 및 주행거리 테스트, NVH·EMI 측정, 내구성·충돌 테스트, 시뮬레이션·디지털 트윈 기술, 다이나모미터, 배기가스 측정 시스템, 시험장 서비스 등이 다뤄집니다. 100개 이상 전시사, 4,000명 이상 산업 전문가, 30명 이상 연사가 참가합니다. 누수 테스트 커넥터, HIL 시스템, 고속 이더넷 테스트, AI 기반 소프트웨어 검증 도구 등이 전시됩니다.',
    'schedule.item5.title':
      'SDV & AIDV Week 2026 - 소프트웨어 정의 차량·AI 기반 차량 주간',
    'schedule.item5.content':
      'SDV & AIDV Week 2026(소프트웨어 정의 차량·AI 기반 차량 주간)이 오늘부터 3월 20일까지 독일 프랑크푸르트에서 AutoSec Europe 2026과 동시 개최됩니다. 소프트웨어 정의 차량(SDV) 아키텍처, AI 기반 자동차 기술, 차량 소프트웨어 플랫폼, OTA 업데이트, 차량-클라우드 통합, 차량 내 AI 처리 시스템 등이 주요 논의 주제입니다. 자동차 산업의 소프트웨어 중심 전환, 빅테크와 OEM 간 플랫폼 경쟁, 차량 데이터 수익화, 연결차량 보안 등도 다뤄집니다. 자동차 제조사, Tier 1 공급업체, 소프트웨어 기업, AI 기업, 클라우드 기업이 참석합니다.',
    'notice.updateContent20260319': `<strong>2026-03-19</strong> - eBook Series 게시판, 일반상식 게시판, 오늘의 일정(자동차/IT)을 업데이트했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「택시에서 사용하는 실전 영어」가 추가되었습니다. 해외 여행이나 출장 시 택시를 이용할 때 필요한 실용적인 영어 표현과 대화 패턴을 중심으로 구성되어 있으며, 택시 승차·하차, 목적지 안내, 요금 문의·결제, 경로 관련 대화 등 다양한 상황의 영어 표현을 쉽게 학습할 수 있도록 정리했습니다. 택시에서 사용하는 영어는 해외 방문 시 필수적인 실무 영어이므로, 실용적인 영어 학습 자료로 활용할 수 있습니다. 앞으로 계속해서 다양한 주제의 실용적인 영어 학습 자료를 제공할 예정입니다.<br /><br />
📚 <strong>일반상식:</strong> 「앵커링 효과(Anchoring Bias)」가 추가되었습니다. 앵커링 효과는 의사결정 시 처음 제시된 정보(앵커)에 과도하게 의존하여 판단이 왜곡되는 인지적 편향을 의미합니다. 심리학자 다니엘 카너먼과 아모스 트버스키가 1974년에 제안한 개념으로, 사람들이 수치를 추정할 때 처음 제시된 숫자에 지나치게 끌려가는 현상을 설명합니다. 협상, 가격 결정, 투자, 소비 등 다양한 상황에서 중요한 역할을 하며, 마케팅과 판매 전략에서도 널리 활용됩니다. 앵커링 효과의 개념, 발생 원인, 실제 적용 사례, 극복 방법 등을 상세히 다룹니다.<br /><br />
📅 <strong>오늘의 일정(자동차/IT):</strong> 3월 19일 글로벌 자동차 및 IT 부문 일정이 업데이트되었습니다. AI & IoT in Connected Vehicles 웨비나(연결차량 수익화, Zoom 온라인), AutoSec Europe 2026(유럽 자동차 사이버보안·데이터 보안 서밋, 프랑크푸르트), 제16회 Automotive Cybersecurity Summit 2026(보안·혁신·ROI 균형, 미국 앤아버), Automotive Testing Expo Korea 2026(자동차 테스팅 기술 전시회, 킨텍스), SDV & AIDV Week 2026(소프트웨어 정의 차량·AI 기반 차량 주간, 프랑크푸르트) 등이 개최됩니다. 연결차량 수익화, 자동차 사이버보안, 소프트웨어 정의 차량 등이 주요 논의 주제입니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'schedule.item1.title':
      'AI & IoT in Connected Vehicles Webinar - Connected Vehicle Monetization',
    'schedule.item1.content':
      'The AI & IoT in Connected Vehicles Webinar will be held today from 2:00 AM to 3:00 AM (Korea time, 12:00-1:00 PM EST) online via Zoom. Hosted by AutoMobility Advisors and Devox Software, key topics include connected vehicle monetization, turning telematics data into revenue products, regulatory pressure from the EU Data Act and U.S. state privacy legislation, the cockpit control battle between Big Tech and OEMs, predictive maintenance SaaS, and subscription model performance. A real-world case study from a heavy-duty OEM with 50,000 connected vehicles, scaling recurring revenue in fleet predictive maintenance SaaS, and why subscription models underperform in consumer segments will be discussed. Professionals in connected services, digital product strategy, and revenue development at automakers, Tier 1 suppliers, and mobility platforms will attend.',
    'schedule.item2.title':
      'AutoSec Europe 2026 - Europe Automotive Cybersecurity & Data Security Summit',
    'schedule.item2.content':
      'The 2nd Europe Automotive Cybersecurity and Data Security Summit (AutoSec Europe 2026) will be held today through March 20 in Frankfurt, Germany. Key topics include managing supply chain security in Internet of Vehicles, China\'s mandatory vehicle cybersecurity requirements, post-quantum cryptography\'s impact on automotive security, EU AI cybersecurity standardization for connected vehicles, UN R155 compliance challenges, penetration testing and vehicle-to-cloud security, AI-assisted Threat Analysis and Risk Assessment (TARA), and software-defined vehicle (SDV) security. The event attracts 2,000+ attendees, 50+ car makers, and 40+ experts. Automotive cybersecurity professionals, OEMs, security software providers, and Tier 1/2 suppliers are the target audience.',
    'schedule.item3.title':
      '16th Automotive Cybersecurity Summit 2026 - Balancing Security, Innovation & ROI',
    'schedule.item3.content':
      'The 16th Automotive Cybersecurity Summit 2026 will be held today (March 19, Day 2) at the Sheraton Ann Arbor Hotel in Ann Arbor, Michigan, USA. Organized by Automotive IQ, the 2026 theme is "Balancing Security, Innovation & ROI." Key areas include Product/Vehicle Security, IT/OT Security, Manufacturing Security, Application Security, and Embedded Security. Topics cover AI-driven cyber-attacks, software-defined vehicles (SDVs), R155 compliance, CRA/SBOM/HBOM requirements, and post-quantum cryptography (PQC). Over 40 automotive security speakers from Stellantis, Ford, Harman, Bosch, Lucid Motors, and others will present. Technology innovators, software developers, automotive engineers, and cybersecurity professionals will attend.',
    'schedule.item4.title':
      'Automotive Testing Expo Korea 2026 - Automotive Testing Technology Exhibition',
    'schedule.item4.content':
      'Automotive Testing Expo Korea 2026 will be held today (March 19, Day 2) at KINTEX Hall 10B, Goyang, Korea. Running March 18-20, it is Korea\'s leading international event for automotive component testing, development, and validation technologies. Topics include ADAS and autonomous vehicle testing, electric and hybrid powertrain testing, battery and range testing, NVH and EMI measurement, durability and crash testing, simulation and digital twin technologies, dynamometers, emissions measurement systems, and proving ground services. The event features 100+ exhibitors, 4,000+ industry professionals, and 30+ speakers. Exhibits include leak test connectors, HIL systems for autonomous vehicles, high-speed ethernet testing, and AI-powered software validation tools.',
    'schedule.item5.title':
      'SDV & AIDV Week 2026 - Software-Defined Vehicle & AI-Driven Vehicle Week',
    'schedule.item5.content':
      'SDV & AIDV Week 2026 (Software-Defined Vehicle & AI-Driven Vehicle Week) will be held today through March 20 in Frankfurt, Germany, co-located with AutoSec Europe 2026. Key topics include software-defined vehicle (SDV) architecture, AI-driven vehicle technology, vehicle software platforms, OTA updates, vehicle-cloud integration, and in-vehicle AI processing systems. The shift to software-centric automotive industry, platform competition between Big Tech and OEMs, vehicle data monetization, and connected vehicle security are also discussed. Automakers, Tier 1 suppliers, software companies, AI companies, and cloud providers will attend.',
    'notice.updateContent20260319': `<strong>2026-03-19</strong> – We've updated the eBook Series board, General Knowledge board, and Today's Schedule (Automotive/IT).<br /><br />
📖 <strong>eBook Series:</strong> "Practical English for Taxi" has been added. It focuses on practical English expressions and conversation patterns needed when using taxis during overseas travel or business trips, organized to make learning English easy and practical. It covers various situations such as hailing a taxi, giving directions to the driver, asking about fares and making payments, and route-related conversations. English for taxi use is essential for international visits, making this a practical English learning resource. We plan to continue providing practical English learning materials on various topics in the future.<br /><br />
📚 <strong>General Knowledge:</strong> "Anchoring Bias" has been added. Anchoring bias refers to a cognitive bias where people rely too heavily on the first piece of information (the anchor) when making decisions, leading to distorted judgments. Proposed by psychologists Daniel Kahneman and Amos Tversky in 1974, it explains the phenomenon where people are overly influenced by the first number presented when estimating values. It plays an important role in various situations such as negotiation, pricing, investment, and consumption, and is widely used in marketing and sales strategies. The article covers the concept, causes, real-world applications, and strategies to overcome anchoring bias in detail.<br /><br />
📅 <strong>Today's Schedule (Automotive/IT):</strong> March 19 global automotive and IT sector schedules have been updated. Events include AI & IoT in Connected Vehicles Webinar (connected vehicle monetization, online via Zoom), AutoSec Europe 2026 (Europe Automotive Cybersecurity & Data Security Summit, Frankfurt), 16th Automotive Cybersecurity Summit 2026 (Balancing Security, Innovation & ROI, Ann Arbor, USA), Automotive Testing Expo Korea 2026 (automotive testing technology exhibition, KINTEX), and SDV & AIDV Week 2026 (Software-Defined Vehicle & AI-Driven Vehicle Week, Frankfurt). Key discussion topics include connected vehicle monetization, automotive cybersecurity, and software-defined vehicles.<br /><br />
