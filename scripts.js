...
const translations = {
  ko: {
    ...
    'schedule.item1.title':
      '반도체패키징기술의 AI·양자첨단인프라적용기술포럼 2026',
    'schedule.item1.content':
      '반도체패키징기술의 AI·양자첨단인프라적용기술포럼 2026이 오늘 오후 1시부터 6시까지(한국 시간) 서울 과학기술컨벤션센터(ST Center) 대회의실 2(B1F)에서 개최됩니다. 이 포럼은 자동차 IT 분야와 관련된 반도체 패키징 기술에 AI와 양자 기술 등 첨단 인프라 기술을 적용하는 내용을 다룹니다. 자동차 전자제품의 소형화, 고성능화, 저전력화를 위한 반도체 패키징 기술, AI 칩 패키징 기술, 양자 컴퓨팅을 위한 패키징 기술, 자동차용 반도체의 신뢰성 향상 기술 등이 주요 논의 주제입니다. 자동차 반도체 시장 동향, 차세대 패키징 기술 전망, AI·양자 기술 적용 사례 등도 다뤄집니다. 한국마이크로전자 및 패키징학회(KMEPS)가 주최하며, 반도체 기업, 자동차 부품 기업, IT 기업, 연구기관이 참석합니다.',
    'schedule.item2.title':
      '현대모비스 SDV·ADAS 기술 세미나 및 협력사 미팅',
    'schedule.item2.content':
      '현대모비스가 오늘 오전 10시부터 오후 5시까지(한국 시간) 서울 본사에서 소프트웨어 정의 차량(SDV) 및 첨단운전자보조시스템(ADAS) 기술 세미나 및 협력사 미팅을 개최합니다. 최근 퀄컴과의 SDV·ADAS 분야 협력 업무협약을 바탕으로 신흥시장 최적화 통합 솔루션 개발 전략, 글로벌 고객사 수주 활동 계획, SDV 플랫폼 기술, ADAS 센서 융합 기술 등이 주요 논의 주제입니다. 또한 현대모비스가 개발 중인 5G 통신 기반 안테나일체형 텔레매틱스 제어기(MTCU) 기술과 상반기 개발 완료 계획도 공유됩니다. 자율주행 및 SDV를 위한 통신 기술, 차량용 소프트웨어 아키텍처, 센서 융합 알고리즘 등도 다뤄집니다. 현대모비스 관계자, 협력사 대표, 기술 파트너, 연구기관이 참석합니다.',
    'schedule.item3.title':
      '현대차그룹 AI 로보틱스 생태계 구축 전략 워크샵',
    'schedule.item3.content':
      '현대차그룹이 오늘 오전 9시부터 오후 4시까지(한국 시간) 서울 강남구 현대차그룹 본사에서 AI 로보틱스 생태계 구축 전략 워크샵을 개최합니다. CES 2026에서 발표한 AI 로보틱스 전략을 바탕으로 2028년까지 연간 3만 대의 로봇 양산 체계 마련 계획, 그룹사 간 역할 분담 전략, 보스턴다이나믹스와의 협력 방안 등이 주요 논의 주제입니다. 현대모비스의 휴머노이드 로봇 액추에이터 공급 전략, 엔비디아·구글 딥마인드와의 협력 확대 방안, 제조업 및 물류 분야 로봇 상용화 로드맵 등도 다뤄집니다. AI 로보틱스 기술 개발, 로봇 양산 인프라 구축, 글로벌 시장 진출 전략 등이 논의됩니다. 현대차그룹 관계자, 현대모비스, 현대오토에버 등 그룹사 대표, 협력사, 기술 파트너가 참석합니다.',
    'schedule.item4.title':
      '현대오토에버 차량 내비게이션 기술 세미나 및 파트너십 확대',
    'schedule.item4.content':
      '현대오토에버가 오늘 오전 11시부터 오후 3시까지(한국 시간) 서울 여의도 본사에서 차량 내비게이션 기술 세미나 및 파트너십 확대 미팅을 개최합니다. 최근 글로벌 지도 기업 히어 테크놀로지스와의 온라인 내비게이션 파트너십 확대를 바탕으로 북미 시장 현대차·기아·제네시스 100만 대 이상을 대상으로 한 지도 데이터 업데이트 주기 5배 이상 단축 전략, 실시간 내비게이션 서비스 기술, 차량 내비게이션 소프트웨어 플랫폼 등이 주요 논의 주제입니다. 온라인 내비게이션 기술, 지도 데이터 업데이트 시스템, 차량용 내비게이션 UX/UI 개선, 글로벌 시장 확대 전략 등도 다뤄집니다. 현대오토에버 관계자, 히어 테크놀로지스 대표, 현대차·기아 관계자, 내비게이션 기술 협력사가 참석합니다.',
    'schedule.item5.title':
      '한국 자동차 IT 산업 기술 혁신 포럼 2026',
    'schedule.item5.content':
      '한국 자동차 IT 산업 기술 혁신 포럼 2026이 오늘 오후 2시부터 6시까지(한국 시간) 서울 코엑스에서 개최됩니다. 이 포럼은 한국 자동차 IT 산업의 기술 혁신과 미래 전망을 논의하는 종합 포럼입니다. 소프트웨어 정의 차량(SDV), 자율주행 기술, 전기차 기술, 차량용 반도체, 차량용 소프트웨어 플랫폼, AI 기반 차량 서비스 등이 주요 논의 주제입니다. 한국 자동차 IT 산업의 글로벌 경쟁력 강화 방안, 차세대 모빌리티 기술 개발 전략, 자동차-IT 융합 생태계 구축, 글로벌 시장 진출 전략 등도 다뤄집니다. 현대차그룹, 기아, 현대모비스, 현대오토에버, 삼성전자, LG전자, SK하이닉스 등 주요 기업 관계자와 연구기관, 정부 관계자가 참석하여 한국 자동차 IT 산업의 미래를 함께 논의합니다.',
    'notice.updateContent20260206': `<strong>2026-02-06</strong> - eBook Series 게시판에 새로운 콘텐츠를 추가했습니다.<br /><br />
📖 <strong>eBook Series:</strong> 「조직문화는 설계된다」 시리즈의 제4장 「신입을 대하는 방식이 조직의 철학이다」가 연재되었습니다. 조직이 신입을 어떻게 대하는지는 그 조직의 철학과 가치관을 가장 명확하게 보여주는 지표입니다. 이 장에서는 신입을 대하는 방식이 조직문화에 미치는 영향, 신입 온보딩의 중요성, 신입을 대하는 방식이 조직의 철학을 드러내는 메커니즘 등을 심층적으로 분석합니다. 신입을 따뜻하게 환영하고 지원하는 조직은 성장과 발전을 중시하는 조직이며, 신입을 소홀히 하거나 방치하는 조직은 변화와 혁신을 두려워하는 조직입니다. 신입을 대하는 방식은 단순한 인사 정책이 아니라 조직의 근본적인 철학과 가치관을 나타내는 것입니다. 진정한 조직문화를 만들기 위해서는 신입을 존중하고 지원하는 문화를 구축해야 하며, 신입을 대하는 방식이 조직의 철학을 드러내는 핵심 요소입니다.<br /><br />
각 게시판에서 더 자세한 내용을 확인하실 수 있으니 많은 관심 부탁드립니다.`,
  ...
  en: {
    ...
    'schedule.item1.title':
      'Semiconductor Packaging Technology Forum: AI & Quantum Advanced Infrastructure Applications 2026',
    'schedule.item1.content':
      'The Semiconductor Packaging Technology Forum: AI & Quantum Advanced Infrastructure Applications 2026 will be held today from 1:00 PM to 6:00 PM (Korea time) at the ST Center Grand Conference Hall 2 (B1F) in Seoul, Korea. This forum covers the application of advanced infrastructure technologies such as AI and quantum technology to semiconductor packaging technologies related to the automotive IT field. Key topics include semiconductor packaging technologies for miniaturization, high performance, and low power consumption of automotive electronics, AI chip packaging technologies, packaging technologies for quantum computing, and reliability enhancement technologies for automotive semiconductors. Automotive semiconductor market trends, next-generation packaging technology prospects, and AI and quantum technology application cases are also discussed. Hosted by the Korea Microelectronics and Packaging Society (KMEPS), semiconductor companies, automotive parts companies, IT companies, and research institutions will attend.',
    'schedule.item2.title':
      'Hyundai Mobis SDV & ADAS Technology Seminar & Partner Meeting',
    'schedule.item2.content':
      'Hyundai Mobis will hold a Software-Defined Vehicle (SDV) and Advanced Driver Assistance System (ADAS) technology seminar and partner meeting today from 10:00 AM to 5:00 PM (Korea time) at its headquarters in Seoul. Based on the recent business cooperation agreement with Qualcomm in SDV and ADAS fields, key topics include strategies for developing integrated solutions optimized for emerging markets, plans for global customer acquisition activities, SDV platform technologies, and ADAS sensor fusion technologies. Hyundai Mobis will also share information about the 5G communication-based integrated antenna telematics control unit (MTCU) technology under development and plans for completion in the first half of the year. Communication technologies for autonomous driving and SDV, vehicle software architecture, and sensor fusion algorithms are also discussed. Hyundai Mobis representatives, partner company executives, technology partners, and research institutions will attend.',
    'schedule.item3.title':
      'Hyundai Motor Group AI Robotics Ecosystem Strategy Workshop',
    'schedule.item3.content':
      'Hyundai Motor Group will hold an AI Robotics Ecosystem Strategy Workshop today from 9:00 AM to 4:00 PM (Korea time) at its headquarters in Gangnam-gu, Seoul. Based on the AI Robotics strategy announced at CES 2026, key topics include plans to establish a production system for 30,000 robots annually by 2028, inter-affiliate role division strategies, and cooperation plans with Boston Dynamics. Strategies for Hyundai Mobis to supply actuators for humanoid robots, plans to expand cooperation with NVIDIA and Google DeepMind, and roadmaps for robot commercialization in manufacturing and logistics are also discussed. AI robotics technology development, robot production infrastructure construction, and global market entry strategies are covered. Hyundai Motor Group representatives, affiliate executives including Hyundai Mobis and Hyundai Autoever, partners, and technology partners will attend.',
    'schedule.item4.title':
      'Hyundai Autoever Vehicle Navigation Technology Seminar & Partnership Expansion',
    'schedule.item4.content':
      'Hyundai Autoever will hold a vehicle navigation technology seminar and partnership expansion meeting today from 11:00 AM to 3:00 PM (Korea time) at its headquarters in Yeouido, Seoul. Based on the recent expansion of online navigation partnership with global mapping company HERE Technologies, key topics include strategies to reduce map data update cycles by more than 5 times for over 1 million Hyundai, Kia, and Genesis vehicles in the North American market, real-time navigation service technologies, and vehicle navigation software platforms. Online navigation technologies, map data update systems, vehicle navigation UX/UI improvements, and global market expansion strategies are also discussed. Hyundai Autoever representatives, HERE Technologies executives, Hyundai and Kia representatives, and navigation technology partners will attend.',
    'schedule.item5.title':
      'Korea Automotive IT Industry Technology Innovation Forum 2026',
    'schedule.item5.content':
      'The Korea Automotive IT Industry Technology Innovation Forum 2026 will be held today from 2:00 PM to 6:00 PM (Korea time) at COEX in Seoul. This comprehensive forum discusses technology innovation and future prospects of the Korean automotive IT industry. Key topics include Software-Defined Vehicles (SDV), autonomous driving technologies, electric vehicle technologies, automotive semiconductors, vehicle software platforms, and AI-based vehicle services. Strategies to strengthen the global competitiveness of the Korean automotive IT industry, next-generation mobility technology development strategies, automotive-IT convergence ecosystem construction, and global market entry strategies are also discussed. Representatives from major companies including Hyundai Motor Group, Kia, Hyundai Mobis, Hyundai Autoever, Samsung Electronics, LG Electronics, and SK Hynix, as well as research institutions and government officials, will attend to discuss the future of the Korean automotive IT industry together.',
    'notice.updateContent20260206': `<strong>2026-02-06</strong> – We've added new content to the eBook Series board.<br /><br />
📖 <strong>eBook Series:</strong> Chapter 4 "How We Treat Newcomers Reflects the Organization's Philosophy" of the series "Organizational Culture is Designed" has been serialized. How an organization treats newcomers is the clearest indicator of its philosophy and values. This chapter provides an in-depth analysis of how the treatment of newcomers affects organizational culture, the importance of newcomer onboarding, and the mechanisms by which how newcomers are treated reveals the organization's philosophy. Organizations that warmly welcome and support newcomers value growth and development, while organizations that neglect or ignore newcomers fear change and innovation. How newcomers are treated is not simply a personnel policy but reflects the organization's fundamental philosophy and values. To create a true organizational culture, we must build a culture that respects and supports newcomers, and how newcomers are treated is a core element that reveals the organization's philosophy.<br /><br />
